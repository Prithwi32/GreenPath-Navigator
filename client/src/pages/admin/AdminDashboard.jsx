            ...
            <div className="chart-with-text">
              ...
              <div className="text-container">
                <p>
                  ...
                  <main>
                    A dynamic overview of carbon emissions from June to
                    November.
                  </main>
                </p>
                <p>
                  The <span className="highlight-text">blue line</span>{" "}
                  illustrates the <strong>targeted amount</strong> of carbon
                  emissions, while the
                  <span className="highlight-text"> green line</span> shows the{" "}
                  <strong>actual emissions</strong> over the same period.
                </p>
                <p>
                  Our goal is to reduce emissions by continuously monitoring the
                  difference, aiming for a{" "}
                  <span className="highlight-text">greener</span> future.
                </p>
              </div>
            </div>
          </div>
